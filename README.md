...
+ Step 4 : Set JDK
  ...
  ```
## Open
| <img width=100%/>`VERSION `<img width=100%/> | <img width=100%/> `8`<img width=100%/> | <img width=100%/> `11`<img width=100%/> | <img width=100%/> `13`<img width=100%/> | <img width=100%/> `14`<img width=100%/> | <img width=100%/> `16`<img width=100%/> 
| :---: | :---: | :---: | :---: | :---: | :---: 
+ Step 1 :
  - JDK
  ```bash
