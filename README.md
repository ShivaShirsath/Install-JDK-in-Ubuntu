...
+ Step 4 : Set JDK
  ...
  ```
## Open
|<img width=50/>`VERSION`<img width=50/>|<img width=10/>`8`<img width=10/>|<img width=10/>`11`<img width=10/>|<img width=10/>`13`<img width=10/>|<img width=10/>`14`<img width=10/>|<img width=10/>`16`<img width=10/>|
| :---: | :---: | :---: | :---: | :---: | :---: |
+ Step 1 :
  - JDK
  ```bash
